...
async def test_index_documents_success(async_client):
    ...
    assert ( doc1["text"] == "This is a test document" or doc2["text"] == "This is a test document")
    assert ( doc1["text"] == "Another test document" or doc2["text"] == "Another test document")
